...
uint8_t MotorInit()
{
	...
	// Limits
	tmc4671_setTorqueFluxLimit_mA(TMC4671_CS, MOTOR_CONFIG_TORQUE_MEASUREMENT_FACTOR, MOTOR_CONFIG_PID_TORQUE_FLUX_LIMITS); //This does not actually set mA.
...
int16_t MotorGetS16CircleDifference(int16_t newValue, int16_t oldValue)
{
