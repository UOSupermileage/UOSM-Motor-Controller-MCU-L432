...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(ENABLE_6200_GPIO_Port, ENABLE_6200_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : ENABLE_6200_Pin */
  GPIO_InitStruct.Pin = ENABLE_6200_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ENABLE_6200_GPIO_Port, &GPIO_InitStruct);
